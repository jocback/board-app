...
class ReadBoardComponent extends Component {
    ...
    goToUpdate = (event) => {
        ...
        this.props.history.push(`/modify-board/${this.state.boardNo}`);
    }

    deleteView = async function() {
        if(window.confirm("정말로 글을 삭제하시겠습니까?\n삭제된 글은 복구 할 수 없습니다.")) {
            BoardService.deleteBoard(this.state.boardNo).then( res=> {
            ...
            <div>
                <div className="card col-md-6 offset-md-3">
                    ...
                    <div className="card-body">
                        {this.returnBoardType(this.state.board.boardType)}
                        <div className="row">
                        ...
                        <button className="btn btn-primary" onClick={this.goToList.bind(this)} style={{marginLeft:"10px"}}>글 제목으로 이동</button>
